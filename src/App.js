...
import vnsDomain from "./utils/Domains.json";
import polygonLogo from "./assets/polygonlogo.png";
import ethLogo from "./assets/ethlogo.png";
import { networks } from "./utils/networks";
// Constants
const TWITTER_HANDLE = "0xAnto";
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
// Add the domain you will be minting
const tld = ".vibes";
const CONTRACT_ADDRESS = "0x27Fc9872D889DEe24fDB4cE0ED41fb526Da96652";
    ...
    return (
      <div className="form-container">
        ...
        <input
          type="text"
          value={record}
          placeholder="Last song that you enjoyed..."
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <header>
            <div className="left">
              <p className="title">The Vibes Name Service✨</p>
              <p className="subtitle">Let's Vibe on the blockchain!!!</p>
            </div>
...
export default App;
// <p className="title">The Vibes Name Service</p>
// <p className="subtitle">Let's Vibe on blockchain!!</p>
